...
class VideoBookmarkPage extends StatefulWidget {
  @override
  _VideoBookmarkPageState createState() => _VideoBookmarkPageState();
}

class _VideoBookmarkPageState extends State<VideoBookmarkPage> {
  List<dynamic> _data = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text("vidéos enregistrès",
              style: GoogleFonts.nunito(color: Colors.grey[700] ,fontWeight: FontWeight.w700),  ),
          centerTitle: true,
                  ...
                  child: Column(
                    children: [
                      ...
                      BackgroundBookmarkVideo(
                          "assets/images/videos/backroungvideo.jpg"),
